...
def load_args(default_config=None):
  ...
  parser.add_argument('--time_dim', type=int, default=30, help='Max input sequence length in video frames')
  parser.add_argument('--maxlen', type=int, default=30, help='Max output sequence length')
  ...
  parser.add_argument('--test_aug_times', type=int, default=1, help='How many different test augmentations to perform (including original)')
